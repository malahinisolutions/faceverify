  ...
  <div class="container">
    <div class="row align-items-center justify-content-center">
      ...
      <div class="col-md-5 relative align-self-center">
        ...
        <form action="<?php echo base_url('forgot_password');?>" id="forgot_password_validation" class="bg-white rounded pb_form_v1" method="post">
          <h2 class="mb-4 mt-0 text-center">Forgot Password</h2>
<div style="clear:both;"><?php include('validation_message.php'); ?></div>
            <div class="form-group">
                <input type="email" name="login" class="form-control input-form" value ="<?php echo set_value('login');?>" placeholder="Email Address" data-bvalidator="required,email" autocomplete="email" />
                <small class="form-control-feedback"></small>
            </div>

          <div class="form-group">
              <button class="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue"   type="submit">Forgot Password</button>
