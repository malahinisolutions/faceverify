  ...
  <div class="container">
    <div class="row align-items-center justify-content-center">
      ...
      <div class="col-md-5 relative align-self-center">
        ...
        <form action="<?php echo base_url('send_again');?>" id="send_again_validation" class="bg-white rounded pb_form_v1" method="post">
          <h2 class="mb-4 mt-0 text-center">Resend Account Confirmation Instructions</h2>
<div style="clear:both;"><?php include('validation_message.php'); ?></div>
            ...
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        <a href="<?php echo base_url('forgot_password');?>" style="color:#999999">Forgot Password?</a>
                            </label>

                </div>
            </div>
          <div class="form-group">
              <button class="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue"   type="submit">Resend Instructions</button>

          </div>

            <hr />
            <div class="login-text"> Don’t you have an account yet?
                <a href="<?php echo base_url('/register');?>" style="">Register Here </a>
            </div>
