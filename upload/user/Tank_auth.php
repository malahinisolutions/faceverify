...
class Tank_auth
{
	...
	function send_email($type, $email, &$data)
	{
		...
		$this->email->Username = 'testapp894@gmail.com';
		$this->email->Password = 'malahini123';
		$this->email->addReplyTo('testapp894@gmail.com', $this->ci->config->item('website_name', 'tank_auth'));
		$this->email->setFrom('testapp894@gmail.com',$this->ci->config->item('website_name', 'tank_auth'));
